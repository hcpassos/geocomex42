...
anos = [x for x in range(1997,2024)]
...
for ano in anos:
    ...
    if response.status_code == 200:
        ...
        novo_nome_arquivo = f"NCM_{nome_arquivo.split('.')[0]}-{data_hora_atual}.{nome_arquivo.split('.')[-1]}"
        ...
        try:
            ...
            object_name = f"bronze/exp/brasil/fechado/{novo_nome_arquivo}"  # Nome do objeto no S3 (pode ser uma pasta)
